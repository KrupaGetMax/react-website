      ...
      <section className="pb-10 pt-10 dark:bg-dark ">
        <div className="container mx-auto">
          <Swiper slidesPerView={1} ref={sliderRef}>
            <SwiperSlide>
              <SingleTestimonial
                image="https://vocalvideo.com/resources/content/images/2021/09/corporate-testimonial-videos.jpeg"
                reviewImg="https://cdn.tailgrids.com/2.0/image/marketing/images/testimonials/testimonial-01/lineicon.svg"
                reviewAlt="lineicon"
                details="From the moment we started using this platform, everything became so much smoother. The automation features have saved us countless hours, and the support team is always there when we need them."
                name="Larry Diamond"
            ...
            <SwiperSlide>
              <SingleTestimonial
                ...
                reviewImg="https://cdn.tailgrids.com/2.0/image/marketing/images/testimonials/testimonial-01/lineicon.svg"
                reviewAlt="lineicon"
                details="This platform has revolutionized how we manage our projects. The seamless integration and user-friendly interface have boosted our team's productivity. We're thrilled with the results!"
                name="Emily Roberts"
                position="CEO at BrightPath Enterprises."
              />
            </SwiperSlide>
            <SwiperSlide>
              <SingleTestimonial
                image="https://www.crowe.com/ie/-/media/crowe/firms/europe/ie/crowe-ireland/images/crowe-ireland-client-testimonials.jpg?rev=93aee6721081491c958da91763bb239f"
                reviewImg="https://cdn.tailgrids.com/2.0/image/marketing/images/testimonials/testimonial-01/lineicon.svg"
                reviewAlt="lineicon"
                details="Exceptional service and cutting-edge tools! We've seen significant improvements in efficiency and decision-making since adopting this platform. Highly recommended for any growing business."
                name="Mark Davis"
                position="COO at FutureForward Solutions."
              />
            </SwiperSlide>
