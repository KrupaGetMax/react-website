...
import "./Test.css"; // Your custom styles
      ...
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex justify-center items-center gap-y-8 lg:gap-y-0 flex-wrap md:flex-wrap lg:flex-nowrap lg:flex-row lg:justify-between lg:gap-x-8 max-w-sm sm:max-w-2xl lg:max-w-full mx-auto">
          ...
          <div className="w-full lg:w-3/5">
            ...
            >
              <SwiperSlide>
                <div className="group bg-white border border-solid border-gray-300 rounded-2xl max-w-xs mx-auto p-6 transition-all duration-500 hover:border-indigo-600">
              ...
              {/* Add more SwiperSlide components here for more testimonials */}
            </Swiper>
          </div>
        </div>
      </div>
