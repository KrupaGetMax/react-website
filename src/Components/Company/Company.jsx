        ...
        <div className="mb-10 lg:max-w-lg lg:pr-5 lg:mb-0">
          <div className="max-w-xl mb-6">
            ...
            <p className="text-base text-gray-700 md:text-lg">
              we build solutions that transform businesses. With cutting-edge
              technology and a customer-first approach, we help organizations
