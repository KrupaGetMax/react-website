...
//               src="https://www.hubspot.com/hs-fs/hubfs/buyer-persona-research_4.webp?width=595&height=400&name=buyer-persona-research_4.webp"
//               alt="can_help_banner"
//             />
//           </div>
      ...
      <div className="max-w-screen-xl mx-auto py-8 px-4 lg:py-16 lg:px-6 ">
        ...
        <div className="flex flex-col md:flex-row">
          <div className="mr-0 md:mr-8 mb-6 md:mb-0">
            <img
              className="w-1/3 md:w-3/4 mx-auto mt-20" // Adjusted width class here
              src="https://www.hubspot.com/hs-fs/hubfs/buyer-persona-research_4.webp?width=595&height=400&name=buyer-persona-research_4.webp"
              alt="can_help_banner"
            />
          </div>
