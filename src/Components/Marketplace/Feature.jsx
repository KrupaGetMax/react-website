    ...
    <>
      <section className="py-20">
        <div class="container max-w-xl p-6 mx-auto space-y-12 lg:px-8 lg:max-w-7xl">
          <div>
            <h2 class="text-3xl font-semibold text-center sm:text-4xl">
              Discover Our Latest Features
            </h2>
            <p class="max-w-3xl mx-auto mt-4 text-xl text-center ">
              Dive into the newest enhancements designed to elevate your
              learning journey and make every experience more thrilling and
              interactive.
            </p>
          </div>
